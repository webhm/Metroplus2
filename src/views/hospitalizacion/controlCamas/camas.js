...
const iCamasTotales = {
    ...
    view: (_data) => {
        ...
        return [
            m("p.mg-0", [
                // Agregamos clases flexbox (d-flex align-items-center) para forzar la alineación horizontal
                m("div.tx-12.d-flex.align-items-center",
                    (_data.attrs.DIFERENCIA == 1 ? [m("span", {
                        class: "badge badge-danger mg-l-1 mg-r-1",
                        title: "Diferencia"
                    }, [], "X")] : []),

                    (_data.attrs.TIPO !== 'CAMAS TOTAL' ? [m("span", {
                        class: "d-none badge badge-primary mg-l-5 mg-r-1",
                    }, [], _data.attrs.TIPO)] : []),

                    (_data.attrs.NOMBRE_GEMA !== null ? [m("span", {
                        class: "badge badge-primary mg-l-1 mg-r-1", // Se eliminó .wd-100p
                    }, [], "NOMBRE GEMA: " + _data.attrs.NOMBRE_GEMA)] : []),

                    m("span", { // Se eliminó .wd-10p
                        class: "badge badge-primary mg-l-1 mg-r-1",
                    }, [], _data.attrs.HABITACION_GEMA),

                    m("span", {
                        class: "badge badge-light mg-l-1 mg-r-1",
                    }, [], "NHC"),
                    // Se envuelve el texto suelto en un span para mejor alineación en flexbox
                    m("span.mg-r-5", _data.attrs.NHCL),

                    m("span", {
                        class: "badge badge-light mg-l-1 mg-r-1",
                    }, [], "ESTADO GEMA"),
                    m("span.mg-r-5", _data.attrs.ESTADO_GEMA),

                    m("span", {
                        class: "badge badge-light mg-l-1 mg-r-1",
                    }, [], "ESTADO MV"),
                    m("span.mg-r-5", _data.attrs.ESTADO_MV),

                    (_data.attrs.NOMBRE_MV !== null ? [m("span", {
                        class: "badge badge-dark mg-l-1 mg-r-1", // Se eliminó .wd-100p
...
const ControlCamas = {
    ...
    pendienteAlta: 0,
    timerUpdate: 0,
    showCamasDisponibles: false,
    showPendientesAlta: false,
    showEstadoCamas: false,
    showHigienizacion: false,
    oninit: (_data) => {
                        ...
                        m("div.col-12", [
                            ...
                            m("div.table-content.col-12.pd-r-0.pd-l-0.pd-b-20.", [
                                ...
                                m("div.mg-b-10", {
                                    ...
                                    onclick: (e) => {
                                        ControlCamas.showCamasDisponibles = !ControlCamas.showCamasDisponibles;
                                    }
                                }, [
                                    ...
                                    m("div.d-flex", [
                                        ...
                                        m("div",
                                            m("h5.mg-b-0",
                                                (ControlCamas.showCamasDisponibles ? [
                                ...
                                m('div', {
                                    class: ControlCamas.showCamasDisponibles ? '' : 'd-none'
                                }, [
                                ...
                                m("div.mg-b-10", {
                                    style: "cursor:pointer;",
                                    onclick: (e) => {
                                        ControlCamas.showPendientesAlta = !ControlCamas.showPendientesAlta;
                                    }
                                }, [
                                    ...
                                    m("div.d-flex", [
                                        ...
                                        m("div",
                                            m("h5.mg-b-0",
                                                (ControlCamas.showPendientesAlta ? [
                                                    m("i.fas.fa-times-circle"),
                                                    " Cerrar"
                                                ] : [
                                                    m("i.fas.fa-eye"),
                                ...
                                m('div', {
                                    class: ControlCamas.showPendientesAlta ? '' : 'd-none'
                                }, [
                                ...
                                m("div.mg-b-10", {
                                    style: "cursor:pointer;",
                                    onclick: (e) => {
                                        ControlCamas.showEstadoCamas = !ControlCamas.showEstadoCamas;
                                    }
                                }, [
                                ...
                                m('div', {
                                    class: ControlCamas.showEstadoCamas ? '' : 'd-none'
                                ...
                                m("div.mg-b-10", {
                                    style: "cursor:pointer;",
                                    onclick: (e) => {
                                        ControlCamas.showHigienizacion = !ControlCamas.showHigienizacion;
                                    }
                                }, [
                                    ...
                                    m("div.d-flex", [
                                        ...
                                        m("div",
                                            m("h5.mg-b-0",
                                                (ControlCamas.showHigienizacion ? [
                                                    m("i.fas.fa-times-circle"),
                                                    " Cerrar"
                                                ] : [
                                                    m("i.fas.fa-eye"),
                                ...
                                m('div', {
                                    class: ControlCamas.showHigienizacion ? '' : 'd-none'

                                }, [
                                    m("div",
                                        m("input.form-control[type='search'][placeholder='Buscar'][id='searchField']")
                                    ),
                                    m("table.table.table-xs[id='table-higienizacion'][width='100%']"),
                                ]),
