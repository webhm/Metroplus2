        ...
        if (PedidoLISA.examenes !== 0 && Examenes.data !== null) {
            ...
            return PedidoLISA.examenes.Exame.map(function (_val, _i, _contentData) {
                ...
                if (_val.operacao == "E") {
                    return [
                        m(
                            ".tx-14.tx-semibold.tx-danger.d-inline",
                            _i +
                            1 +
                            ": " +
                            _val.descExame +
            ...
            return [
                m("div.pd-10", [m("div.placeholder-paragraph", [m("div.line")])]),
            ];
        }
    },
};
            ...
            .then(function (result) {
                if (result.status) {
                    ...
                    StatusPedido.dataFactMuestras =
                        result.data.dataFacturacion.examenesFact;
                    RecepMuestras.impresora =
                        PedidoLISA.data.PedidoExameLab.atendimento.nomeMaquina;
                    Evoluciones.fetch();
                    Observaciones.fetch();
                } else {
                                ...
                                return m(
                                    ...
                                    m(
                                        ...
                                        [
                                            ...
                                            m("div.toast-body.small", _v._aData.message),
                                        ]
                                    )
                                );
                            } else {
...
const TomaMuestras = {
    ...
    view: () => {
        if (StatusPedido.error) {
            return [m("p.mg-0", StatusPedido.error)];
                            ...
                            m(
                                ...
                                m("table.table.table-dashboard.table-hover.mg-b-0", [
                                    m(
                                        ...
                                        m("tr", [
                                            m(
                                                "th.text-dark.text-left.bg-light[colspan='2']",
                                                "Toma de Muestra"
                                            ),
                                        ]),
                                        m("tr", [
                                            m("th.text-left", "EXAMEN"),
                                            m("th", "CONFIRMACIÓN"),
                                        ])
                                    ),
                                    m("tbody", [
                                        m("tr", [
                                            m(
                                                ...
                                                m("div.custom-control.custom-checkbox", [
                                                    ...
                                                    m(
                                                        "label.custom-control-label[for='selectTomaTodos']",
                                                        "Seleccionar Todos"
                                                    ),
                                                ])
                                            ),
                                                ...
                                                m("tr", [
                                                    ...
                                                    m(
                                                        ...
                                                        m("div.custom-control.custom-checkbox.tx-16", [
                                                            ...
                                                            m(
                                                                "label.custom-control-label.tx-16[for='" +
                                                                _val.CD_EXA_LAB +
                                                                "']",
                            ...
                            m(
                                ...
                                m("table.table.table-dashboard.table-hover.mg-b-0", [
                                    m(
                                        ...
                                        m("tr", [
                                            m("th.text-left", "INSUMOS"),
                                            m("th.text-left", "CANTIDAD"),
                                        ])
                                    ),
                                    m("tbody", [
                                        m("tr", [
                                            m(
                                                ...
                                                m("div.custom-control.custom-checkbox.tx-16", [
                                                    ...
                                                    m(
                                                        "label.tx-20.tx-semibold.custom-control-label[for='tuboLila']",
                                                        "Tubo Lila"
                                                    ),
                                                ])
                                            ),
                                        ...
                                        m("tr", [
                                            m(
                                                ...
                                                m("div.custom-control.custom-checkbox.tx-16", [
                                                    ...
                                                    m(
                                                        "label.tx-20.tx-semibold..custom-control-label[for='tuboRojo']",
                                                        "Tubo Rojo"
                                                    ),
                                                ])
                                            ),
                                        ...
                                        m("tr", [
                                            m(
                                                ...
                                                m("div.custom-control.custom-checkbox.tx-16", [
                                                    ...
                                                    m(
                                                        "label.tx-20.tx-semibold..custom-control-label[for='tuboCeleste']",
                                                        "Tubo Celeste"
                                                    ),
                                                ])
                                            ),
                                        ...
                                        m("tr", [
                                            m(
                                                ...
                                                m("div.custom-control.custom-checkbox.tx-16", [
                                                    ...
                                                    m(
                                                        "label.tx-20.tx-semibold..custom-control-label[for='tuboNegro']",
                                                        "Tubo Negro"
                                                    ),
                                                ])
                                            ),
                                        ...
                                        m("tr", [
                                            m(
                                                ...
                                                m("div.custom-control.custom-checkbox.tx-16", [
                                                    ...
                                                    m(
                                                        "label.tx-20.tx-semibold..custom-control-label[for='tuboVerde']",
                                                        "Tubo Verde"
                                                    ),
                                                ])
                                            ),
                                        ...
                                        m("tr", [
                                            m(
                                                ...
                                                m("div.custom-control.custom-checkbox.tx-16", [
                                                    ...
                                                    m(
                                                        "label.tx-20.tx-semibold..custom-control-label[for='gsav']",
                                                        "GSA V"
                                                    ),
                                                ])
                                            ),
                                        ...
                                        m("tr", [
                                            m(
                                                ...
                                                m("div.custom-control.custom-checkbox.tx-16", [
                                                    ...
                                                    m(
                                                        "label.tx-20.tx-semibold..custom-control-label[for='hemocultivo']",
                                                        "Hemocultivo"
                                                    ),
                                                ])
                                            ),
                                        ...
                                        m("tr", [
                                            m(
                                                ...
                                                m("div.custom-control.custom-checkbox.tx-16", [
                                                    ...
                                                    m(
                                                        "label.tx-20.tx-semibold..custom-control-label[for='qtb']",
                                                        "QTB"
                                                    ),
                                                ])
                                            ),
...
const ControlLISA = {
    ...
    generarXML: () => {
        ...
        if (Examenes.medico !== null && Examenes.medico !== false) {
            PedidoLISA.data.PedidoExameLab.atendimento.prestadorSolicitante =
                Examenes.medico.CODMEDICO;
            PedidoLISA.data.PedidoExameLab.atendimento.descPrestadorSolicitante =
                Examenes.medico.PRESTADOR;
            PedidoLISA.data.PedidoExameLab.atendimento.numeroConselhoSolicitante =
                Examenes.medico.CEDULA;
        }
    ...
    view: () => {
        if (ControlLISA.logsEnvio.length !== 0) {
                    ...
                    m(
                        ...
                        [
                            ...
                            m(
                                ...
                                m("br"),
                                m(
                                    ".d-inline.tx-danger.tx-semibold",
            ...
            return [
                m("tr", [m("td.tx-16.tx-medium.text-left", "No existe envíos.")]),
            ];
        }
    },
};
                                    ...
                                    m(
                                        ...
                                        m("table.table.table-dashboard.table-hover.mg-b-0", [
                                            m(
                                                ...
                                                m("tr", [
                                                    m("th.text-left", "EXAMEN(ES)"),
                                                    m("th[colspan='2']", "CONFIRMACIÓN PARA FACTURACIÓN"),
                                                ])
                                            ),
                                            m("tbody", [
                                                m(
                                                    ...
                                                    [
                                                        m(
                                                            ...
                                                            m("div.custom-control.custom-checkbox", [
                                                                ...
                                                                m(
                                                                    "label.custom-control-label[for='rf_selectTomaTodos']",
                                                                    "Seleccionar Todos"
                                                                ),
                                                            ])
                                                        ),
                                                        ...
                                                        m("tr", [
                                                            ...
                                                            m(
                                                                ...
                                                                m("div.custom-control.custom-checkbox.tx-16", [
                                                                    ...
                                                                    m(
                                                                        "label.custom-control-label.tx-16[for='r_" +
                                                                        _val.CD_EXA_LAB +
                                                                        "']",
                                                                        StatusPedido.dataFactMuestras[_i][
                                                                            "STATUS_FACT"
    ...
    examenNuevoPedido: (examen, pedido, xml) => {
        return StatusPedido.dataMuestras.map(function (_val, _i, _contentData) {
            if (examen.codigoExame === _val.CD_EXA_LAB) {
                ...
                StatusPedido.dataMuestras[_i]["NM_EXA_LAB"] =
                    "*" + examen.descExame + " (" + pedido.codigoPedido + ")";
            }
        });
    },
    seleccionarTodos: (status) => {
                        ...
                        m(
                            "button.btn.btn-xs.btn-primary.mg-r-5[type='button']",
                            {
                                onclick: () => {
                                    if (
                                        confirm(
                                            "Esta seguro de generar un nuevo pedido 88.000.000."
                                        ) == true
                                    ) {
                                        RecepMuestras.disabledToma = false;
                                ...
                                m(
                                    ...
                                    m("table.table.table-dashboard.table-hover.mg-b-0", [
                                        m(
                                            ...
                                            m("tr", [
                                                m("th.text-left", "EXAMEN(ES)"),
                                                m("th[colspan='2']", "CONFIRMACIÓN Y ENVÍO LISA"),
                                            ])
                                        ),
                                        m("tbody", [
                                            m("tr", [
                                                m(
                                                    ...
                                                    m("div.custom-control.custom-checkbox", [
                                                        ...
                                                        m(
                                                            "label.custom-control-label[for='r_selectTomaTodos']",
                                                            "Seleccionar Todos"
                                                        ),
                                                    ])
                                                ),
                                                                        ...
                                                                        onclick: function (e) {
                                                                            ...
                                                                            if (p) {
                                                                                ...
                                                                                if (
                                                                                    ...
                                                                                    alert(
                                                                                        "No es posible esta acción. Ya existe un pedido generado."
                                                                                    );
                                                                                    throw "No es posible esta acción. Ya existe un pedido generado.";
                                                                                } else {
                                                                                    if (ControlLISA.nuevoPedido) {
                                                                                        alert(
                                                                                            "No es posible generar un Nuevo Pedido de este exámen."
                                                                                        );
                                    ...
                                    m("table.table.table-dashboard.table-hover.mg-b-0", [
                                        m(
                                            ...
                                            m("tr", [
                                                m("th", "EXAMENES:"),
                                                m("th", "FECHA Y HORA:"),
                                                m("th.d-none", "OPCIONES:"),
                                            ])
                                        ),
                                        m("tbody", [m(ControlLISA)]),
                                    ])
                                ),
                            ]
                        ),
...
const PedidoLISA = {
    ...
    oninit: (_data) => {
        if (
            _data.attrs.numeroPedido !== undefined &&
            _data.attrs.idTimeRecord !== undefined
        ) {
            document.title =
                "Detalle de Pedido N°: " + _data.attrs.numeroPedido + " | " + App.title;
    ...
    view: (_data) => {
        if (PedidoLISA.data.length !== 0) {
            let nacimiento = moment(
                PedidoLISA.data.PedidoExameLab.paciente.dataNascimento
            );
            let hoy = moment();
            PedidoLISA.data.PedidoExameLab.paciente.anios = hoy.diff(
                nacimiento,
                "years"
            );
        }
